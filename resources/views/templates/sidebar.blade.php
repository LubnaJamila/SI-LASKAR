<div id="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        @if (auth()->user()->role === 'admin')
            ...
            <li class="nav-item">
                <a href="{{ route('rencana_tim') }}"
                    class="nav-link {{ Request::is('rencana_tim*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('wps') }}" class="nav-link {{ Request::is('wps*') ? 'active' : '' }}">
                    <i class="bi bi-gender-female"></i> <span>Clustering WPS </span>
                </a>
            </li>
        ...
        @if (auth()->user()->role === 'petugas')
            ...
            <li class="nav-item">
                <a href="{{ route('petugas.hotspot') }}"
                    class="nav-link {{ Request::is('petugas/hotspot*') ? 'active' : '' }}">
                    <i class="bi bi-wifi menu-icon"></i><span>Hotspot</span>
                </a>
            </li>

            <li class="nav-item">
                <a href="{{ route('rencana_kunjungan') }}"
                    class="nav-link {{ Request::is('rencana_kunjungan*') ? 'active' : '' }}">
                    <i class="bi bi-calendar4-week"></i> <span>Rencana Kunjungan</span>
                </a>
            </li>

            <li class="nav-item">
                <a href="{{ route('kunjungan_saya') }}"
                    class="nav-link {{ Request::is('kunjungan_saya*') ? 'active' : '' }}">
                    <i class="bi bi-clock-history"></i> <span>Kunjungan Saya</span>
                </a>
            </li>
        @endif
    </ul>
